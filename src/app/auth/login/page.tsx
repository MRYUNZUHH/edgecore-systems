  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-pink-800 to-orange-600">
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl border border-white/20 shadow-2xl">
        ...
        <p className="text-gray-400 mb-6">Sign in to your EdgeCore account</p>
        ...
        <div className="space-y-4">
          ...
          <button onClick={handleSubmit} className="btn-primary w-full py-3 text-lg font-bold">Sign In</button>
        </div>
